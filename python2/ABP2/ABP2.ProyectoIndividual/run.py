...
Agregar una nueva clase pertinente a la aplicación que están desarrollando e identificar en ella al menos
cuatro atributos (uno de ellos debe ser opcional). Agréguela al diagrama intuitivo que realizó en la
actividad anterior. 
Se deberá crear métodos para cada uno de los usuarios. Piensen en diferentes acciones particulares que
pueda ejecutar cada una de sus clases. Desarrolle cuatro métodos por cada clase. Dos deben incluir
